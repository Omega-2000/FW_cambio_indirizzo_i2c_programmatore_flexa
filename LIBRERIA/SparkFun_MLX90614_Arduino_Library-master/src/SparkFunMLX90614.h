...
and abstracts temperature measurements and other features of the MLX90614
...
public:
	...
	//aggiunta io
	//invia il registro di controllo del PWM
	//restituisce 0 / 1
	uint8_t setEEPROM(uint16_t reg, int16_t data);
	uint8_t setCONFIG(int16_t config);
	void busRequest();
	void printAll();
